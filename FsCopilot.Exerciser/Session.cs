...
/// refused outright. MasterSwitch registers SetMaster before the Coordinator's five.
/// </summary>
public sealed class Session : IDisposable
{
    ...
    public Session(string relayHost)
    {
        ...
        _net.RegisterPacket<MasterSwitch.SetMaster, MasterSwitch.SetMaster.Codec>();
        _net.RegisterPacket<Coordinator.Update, Coordinator.Update.Codec>();
        _net.RegisterPacket<Interact, Coordinator.InteractCodec>();
    ...
    {
        _net.SendAll(new MasterSwitch.SetMaster(PeerId));
